...
...
```
<u>If the head is ever two steps directly up, down, left, or right from the tail, the tail must also move one step in that direction so it remains close enough</u>:
```
.....    .....    .....
.TH.. -> .T.H. -> ..TH.
.....    .....    .....
...
...    ...    ...
```
Otherwise, <u>if the head and tail aren't touching and aren't in the same row or column, the tail always moves one step diagonally to keep up</u>:
```
.....    .....    .....
.....    ..H..    ..H..
..H.. -> ..... -> ..T..
...
*One knot is still the head of the rope and moves according to the series of motions. <u>Each knot further down the rope follows the knot in front of it using the same rules as before</u>.*
